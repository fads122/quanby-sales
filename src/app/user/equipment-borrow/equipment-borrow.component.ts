...
//       // Fetch equipment and borrowed items in parallel for better performance
...
//       // Map equipment with correct status and availability
...
//                 equipment.condition === 'Working' ? EquipmentStatus.WORKING :
//                 equipment.condition === 'Inactive' ? EquipmentStatus.INACTIVE : 
//                 equipment.status || EquipmentStatus.AVAILABLE)
//       };
//     });

//       // Filter if specific equipment selected
...
//       // Consider adding user feedback here (toast/snackbar)
//     }
//   });
// }
async ngOnInit(): Promise<void> {
